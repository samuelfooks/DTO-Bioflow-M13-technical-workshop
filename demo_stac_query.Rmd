...
if (length(items_query$features) > 0) {
  ...
  # Override the Parquet asset URL for testing
  parquet_asset <- 'https://s3.waw3-1.cloudferro.com/emodnet/emodnet_biology/12639/eurobis_obisenv_view_2025-03-20.parquet'
